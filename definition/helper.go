...
// DescriptorFor creates a descriptor.
func DescriptorFor(path string, description string) Descriptor {
	return Descriptor{
		Path:        path,
...
func NewDefinition(method Method, f interface{}, description string) Definition {
	return Definition{
		Method:      method,
		Function:    f,
		Description: description,
...
// ListDefinitionFor creates a defnition for method list.
func ListDefinitionFor(f interface{}, description string) Definition {
	return NewDefinition(List, f, description)
}

// GetDefinitionFor creates a defnition for method get.
func GetDefinitionFor(f interface{}, description string) Definition {
	return NewDefinition(Get, f, description)
}

// CreateDefinitionFor creates a defnition for method create.
func CreateDefinitionFor(f interface{}, description string) Definition {
	return NewDefinition(Create, f, description)
}

// UpdateDefinitionFor creates a defnition for method update.
func UpdateDefinitionFor(f interface{}, description string) Definition {
	return NewDefinition(Update, f, description)
}

// PatchDefinitionFor creates a defnition for method patch.
func PatchDefinitionFor(f interface{}, description string) Definition {
	return NewDefinition(Patch, f, description)
}

// DeleteDefinitionFor creates a defnition for method delete.
func DeleteDefinitionFor(f interface{}, description string) Definition {
	return NewDefinition(Delete, f, description)
}

// AsyncCreateDefinitionFor creates a defnition for method async create.
func AsyncCreateDefinitionFor(f interface{}, description string) Definition {
	return NewDefinition(AsyncCreate, f, description)
}

// AsyncUpdateDefinitionFor creates a defnition for method async update.
func AsyncUpdateDefinitionFor(f interface{}, description string) Definition {
	return NewDefinition(AsyncUpdate, f, description)
}

// AsyncPatchDefinitionFor creates a defnition for method async patch.
func AsyncPatchDefinitionFor(f interface{}, description string) Definition {
	return NewDefinition(AsyncPatch, f, description)
}

// AsyncDeleteDefinitionFor creates a defnition for method async delete.
func AsyncDeleteDefinitionFor(f interface{}, description string) Definition {
	return NewDefinition(AsyncDelete, f, description)
}
